...
Database: MySQL
Tools & Platforms: Git, GitHub, MS Excel, Power BI, Linux
Other.

## 📂 Featured Projects

* 🤖 AI-Based Automated Multilingual Translation of Exam Question Papers
* 🧮 Calculator App
...
* **Python Full Stack Developer Intern** — BR Concepts Pvt Ltd
* **Android Development Intern** — SkillCraft Technology
* **Python Programming Intern** — SkillDzire
